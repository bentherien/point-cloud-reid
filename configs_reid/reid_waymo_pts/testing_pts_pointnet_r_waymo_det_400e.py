...
neptune_tags = ['waymo','only-match','testing','Pointnet','point-cat']
...
# load_from='pretrained/reid/only-match/pts_pointnet_r_waymo_det_400e.pth'
# load_from='pretrained/reid/ablation/pts_pointnet_r_waymo_det_400e.pth'
