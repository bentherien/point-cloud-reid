_base_ = [
    "./testing_base.py",
    "../_base_/reidentifiers/reid_1.5M_point-transformer-point-cat-lin-xcorr_fp.py",
    "../_base_/schedules/cyclic_400e_lr1e-5.py",
]

neptune_tags = ['waymo','only-match','testing','Point Transformer','point-cat','1600e','EVEN','norm1']
