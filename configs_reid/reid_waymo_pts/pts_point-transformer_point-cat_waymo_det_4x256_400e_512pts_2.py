_base_ = [
    "../_base_/reidentifiers/reid_pts_point-transformer_point-cat_512pts.py",
...
neptune_tags = ['512 points input','waymo','400e','4 x 256','point-transformer','only match','point-cat']
