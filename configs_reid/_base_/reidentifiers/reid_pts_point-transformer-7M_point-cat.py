...
model = dict(
    ...
    backbone=dict(type='Pointnet_Backbone',input_channels=0,use_xyz=True,conv_out=output_sequence_size,mul=4),
    ...
    match_head=[dict(type='LinearRes', n_in=hidden_size, n_out=hidden_size, norm='GN',ng=16),
