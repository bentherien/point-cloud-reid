_base_ = [
    "./testing_base.py",
    "../_base_/reidentifiers/reid_pts_point-transformer_point-cat.py",
    "../_base_/schedules/cyclic_500e_lr1e-5.py",
]

neptune_tags = ['nus','only-match','testing','Point Transformer','point-cat']
...
# load_from='pretrained/reid/only-match/pts_point-transformer_r_nus_det_500e.pth'